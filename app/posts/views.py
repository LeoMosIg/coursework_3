...
def posts_search():
    ...
    if query != "":
        ...
        numbers_of_posts = len(posts)
    else:
        posts = []
        numbers_of_posts = 0

    return render_template("search.html", query=query, posts=posts, numbers_of_posts=numbers_of_posts)
...
def posts_by_user(username):
    ...
    return render_template("user-feed.html", posts=posts, numbers_of_posts=numbers_of_posts)
